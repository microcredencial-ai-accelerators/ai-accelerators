...
hRD.addAXI4SlaveInterface( ...
    'InterfaceConnection', {'AXI_Manager_0.axm_m0', 'hps_0.f2h_sdram0_data'}, ...
    'BaseAddress',         {'0x00000000', '0x00000000'}, ...
    'InterfaceType',       'AXI4', ...
    'IDWidth',             13);
...
hRD.addAXI4MasterInterface(...
    ...
    'DefaultWriteBaseAddr', hex2dec('80000000'), ...
...
%% Add custom parameters if needed (optional)
% hRD.addParameter('ParameterID', 'value', ...);
...
%% Set workflow
% hRD.TargetWorkflow = hdlcoder.Workflow.DeepLearningProcessor; % Added according to 
